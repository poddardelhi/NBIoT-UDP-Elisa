 ...
 *      Author: Mairo Leier
 *Some modification were done related to definition by Nishant Poddar
 */
#include <stdint.h>
//#ifndef BG96_H_
//#define BG96_H_
...
#define BG96_AT_AP "AT+QICSGP=1,1,\"NB-IOT\",\"\",\"\",0\r\n"
...
#define BG96_URL_CHARACTERS "AT+QHTTPURL=96,80\r\n"
#define BG96_URL_TOKEN "http://industrial.api.ubidots.com/api/devices/ut_telia?token=BBFF-zYdcaSDyFMRO6tE9UOH6sxe4fB7YvH\r\n"
...
#define BG96_HTTP_POST_RSSI "AT+QHTTPPOST=7,80,80\r\n"
#define BG96_HTTP_POST_RSRP "AT+QHTTPPOST=7,80,80\r\n"
#define BG96_HTTP_POST_RSRQ "AT+QHTTPPOST=7,80,80\r\n"
#define BG96_HTTP_POST_SNR "AT+QHTTPPOST=7,80,80\r\n"
//Nishant: Added a line below
//#define BG96_HTTP_GET_SNR "AT+QHTTPGET=80\r\n"
...
#define BG96_POWER_DOWN "AT+QPOWD=1\r\n"  //Normal power down 1, Immediately power down 02
#define BG96_SIGNAL_STRENGTH "AT+QCSQ\r\n"
#define BG96_AT_AP_INTERNET "AT+QICSGP=1,1,\"NB-IOT\",\"\",\"\",0\r\n"
//#define BG96_AT_AP_INTERNET "AT+QICSGP=1,1,\"NBIOT.TELIA.EE\",\"\",\"\",0\r\n"
...
#define BG96_AT_PREPARE_UDP_PCKT "AT+QIOPEN=1,0,\"UDP\",\"169.55.61.243\",9012,0,1\r\n"
//#define BG96_AT_PREPARE_UDP_PCKT "AT+QIOPEN=1,0,\"UDP\",\"node.iot.ttu.ee\",6805,0,1\r\n"
#define BG96_AT_SEND_UDP_PCKT "AT+QISEND=0\r\n"
#define BG96_DATA_STRING "Test/1.0|POST|BBFF-aV1o3Bug6KIJgeQM0bjIpkKkOtfe07|device_3:Device_3=>"
...
#define BG96_AT_PING "AT+QPING=1,\"169.55.61.243\"\r\n"
